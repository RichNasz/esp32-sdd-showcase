...
| [Creating New Board Specs](creating-new-board-specs.md) | How to use esp32-board-spec-generator to add any ESP32 board to the catalog — includes live XIAO ESP32S3 walkthrough |
